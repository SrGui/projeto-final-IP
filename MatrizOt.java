...
class MatrizOt{
	...
	private int detOrdem1(MatrizOt mat){
		return mat.getValor(0,0);
	}
	
	private int detOrdem2(MatrizOt mat){
	...
	private String maisZeros (MatrizOt mat){
	...
	public void copiaMatrizMaiorParaMenor(MatrizOt maior,MatrizOt menor,int isqn,int jsqn){
	...
	private int detOrdemN(MatrizOt mat){
		...
		for(cont = 0; cont < numL; cont++){
			matmenor = new MatrizOt(numL-1,numC-1);
